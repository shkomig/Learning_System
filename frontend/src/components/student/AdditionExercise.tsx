...
export function AdditionExercise({
  ...
  const generateProblem = (diff: Difficulty): ExerciseProblem => {
    ...
    const num2 = randomInt(1, max - num1);
    ...
    <div className="min-h-screen bg-background p-8" dir="rtl">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex gap-8 items-center justify-center mb-8 flex-wrap">
            <VisualDisplay count={problem.num1} type={problem.visual} />
            ...
            <VisualDisplay count={problem.num2} type={problem.visual} />
...
function VisualDisplay({ count, type }: { count: number; type: VisualType }) {
  const visuals = {
    fruits: ['🍎', '🍊', '🍌', '🍇', '🍓'],
    animals: ['🐶', '🐱', '🐭', '🐰', '🐻'],
    blocks: null,
